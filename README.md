...
> The following project includes a CRM Database created using PostgreSQL, and an API which allows users to access Property, Tenancy, Property Manager, and Tenant information. The users for this system include Property Managers, Support Workers and Tenants.
